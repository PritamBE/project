    ...
    while n < width - 1:
        ...
        if(white[n] > (1 - segmentation_spacing) * white_max):
            ...
            if end - start > 5:
                ...
                while truth:
                    path = 'C:/Users/Ironpritam/Desktop/stage1/yolov4/stage2/final/SegmentIMG{}'.format(i)
                    if not os.path.exists(path):
                        os.mkdir(path)
                        cv2.imwrite('C:/Users/Ironpritam/Desktop/stage1/yolov4/stage2/final/SegmentIMG{}/imgCrop.png'.format(i), img)
                        break
                    i+=1
                truth = False
                cv2.imwrite('C:/Users/Ironpritam/Desktop/stage1/yolov4/stage2/final/SegmentIMG{}/img{}.png'.format(i,im), character)
                im+=1
